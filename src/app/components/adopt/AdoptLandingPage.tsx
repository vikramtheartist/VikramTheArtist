...
export const AdoptLandingPage: React.FC<AdoptLandingPageProps> = ({
  ...
  return (
    <div className="adopt-page-wrapper selection:bg-indigo-500 selection:text-white relative">
      ...
      <section id="case-study" className="py-20 lg:py-28 relative overflow-hidden bg-transparent">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-12 max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12">
