...
const routes = [
  ...
  },
  {
    ...
    canonical: "https://vikramtheartist.com/playbook/adopt-v2",
    robots: "index, follow, max-image-preview:large",
  ...
  },
  {
    ...
    canonical: "https://vikramtheartist.com/playbook/adopt-v2", // Canonical points to primary V2
    robots: "noindex, follow", // Prevent duplicate indexing in SERPs
