...
const routes = [
  ...
  },
  {
    ...
    title: "Scaling Copilot through Engage — Community Adoption Case Study | Vikram Venkatesh",
    ...
    robots: "index, follow, max-image-preview:large",
    ogTitle: "Scaling Copilot through Engage — Community Adoption Case Study",
